...
_(Section currently empty — last review 2026-05-05 archived all 9 entries to [docs/cron-learnings-archive.md](docs/cron-learnings-archive.md). Promoted to standing rules: JSX-escape rule, Bash permission-allowlist scope, cron `durable:true` ignored. Promoted to skill: `dispatching-parallel-agent-wave` got a new "When to bundle multiple fixes into ONE commit" section.)_
