...
- **Version:** v3.7.16 — see [CHANGELOG.md](CHANGELOG.md) for the full release history. Per-push gate is currently ~83 Playwright specs / ~2,680 tests + 53 backend vitest files / ~1,413 tests + 10 frontend vitest files / ~89 tests (~4,128 total) across 6 mandatory deploy gates + a separate PR pre-merge checks workflow (vite build + ESLint), with 14 reusable Claude Skills under `.claude/skills/`.
