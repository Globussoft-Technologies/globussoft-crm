...
// AI classifier — only invoked when LEAD_JUNK_AI=1. Goes through aiGateway
// (BYOK or a funded CRM-managed subscription); returns null when the tenant
// has neither (or the call otherwise fails), letting the caller treat the
// lead using only the rule-based score.
