...
const BUILTIN_COLUMNS = {
  leads: [
    ...
    { key: "medium", label: "Medium" }, // Contact.medium — web-form Medium, kept separate from Source
    { key: "tags", label: "Tags" },
  ...
  try {
    ...
    if (pref) {
      ...
      visible = tableKey === "leads"
        ? ["name", "email", "phone", "webForm", "campaign", "callStatus", "callifiedAi", "callifiedScore", "source", "company", "aiScore", "assignedTo"]
