// Emirates (EK) web check-in adapter — Playwright DOM automation.
//
...
async function performCheckIn() {
  return {
    ...
    error: "Emirates (EK) adapter not yet implemented — blocked on PRD DC-1/DC-3/DC-5",
  };
}

module.exports = { airline: "emirates", airlineCodes: ["EK"], performCheckIn };
