...
| G090 | Email template brand-kit consumer (FR-3.1.d, FR-3.3.d) | `lib/emailRender.js` extension | 1.5d | ✅ DONE 2026-06-14 — `2f0cea59` |
...
| G093 | Embed widget brand-kit consumer + `data-sub-brand` attr (FR-3.3.g, FR-3.4.c) | `frontend/public/embed/widget.js` | 1d | ✅ DONE 2026-06-14 — `2f0cea59` |
| G094 | Public landing page brand-kit consumer (FR-3.3.h) | LandingPage renderer | 1d | ✅ DONE 2026-06-14 — `2f0cea59` |
...
| G096 | Sidebar pinned-logo render (FR-3.3.a) | `components/Sidebar.jsx` | 0.5d | ✅ DONE 2026-06-14 — `2f0cea59` |
| G097 | Email send-time sub-brand resolve (FR-3.4.d) | email service | 1d | ✅ DONE 2026-06-14 — `2f0cea59` |
...
| G101 | SMS/WhatsApp display-name interpolation per sub-brand (FR-3.3.e) | `lib/subBrandConfig.js` + SMS/WA services | 1d | ✅ DONE 2026-06-14 — `2f0cea59` |
| G102 | CRM operator pages accent: swap consumer code from `travelSubBrand.js` color map → BrandKit (FR-3.3.b) | grep + sweep | 1.5d | ✅ DONE 2026-06-14 — `2f0cea59` |
