...
// Slice 11 (Accept / Decline workflow) was removed from the operator Quote
// Builder UI in this PR. Quote acceptance/decline now happens through the
// customer share link; the action cluster no longer exposes Accept/Decline
// buttons. Keep the describe block empty so the slice number is preserved.
describe('<QuoteBuilder /> — slice 11 Accept / Decline workflow', () => {
  it('does not render Accept / Decline buttons for a saved quote', async () => {
    mockRouteId = '42';
    renderPage();
    await screen.findByText(/#42/);
