...
export default function CallifiedData() {
  ...
  const fetchCampaignData = async (isManualSync = false) => {
    try {
      ...
      const response = await fetch('/api/integrations/callified/external-transcripts', {
        method: 'GET',
        headers: {
      ...
      {!campaigns.length ? (
        ...
        <div key={campaign.campaign_id} style={styles.campaignCard}>
          ...
          <button
            onClick={() =>
              setExpandedCampaign(
                expandedCampaign === campaign.campaign_id ? null : campaign.campaign_id
              )
            }
            style={{
              ...styles.campaignHeader,
              backgroundColor: expandedCampaign === campaign.campaign_id ? 'var(--card-bg)' : 'transparent',
            }}
          >
            <div style={styles.campaignInfo}>
              ...
              <div style={styles.campaignMeta}>
                ...
                <span style={styles.count}>
                  {campaign.totals.total} leads • {campaign.totals.called} called
                </span>
              </div>
            </div>
            <div style={styles.campaignStats}>
              <div style={styles.statBox}>
                ...
                <span style={styles.statValue}>{campaign.totals.qualified}</span>
              </div>
              <div style={styles.statBox}>
                <span style={styles.statLabel}>Booked</span>
                <span style={styles.statValue}>{campaign.totals.booked}</span>
              </div>
                ...
                campaign.leads.map((lead) => (
                  <div key={lead.lead_id} style={styles.leadCard}>
                    <button
                      onClick={() =>
                        setExpandedLead(
                          expandedLead === lead.lead_id ? null : lead.lead_id
                        )
                      }
                    ...
                    >
                      ...
                      <div style={styles.leadMeta}>
                        <span style={styles.callCount}>{lead.calls.length} calls</span>
                            ...
                            <div style={styles.callHeader}>
                              ...
                              {call.conclusion && (
                                <div style={styles.sentimentBadge}>
                                  {call.conclusion.sentiment === 'positive' ? (
                                ...
                                {call.transcript.map((msg, idx) => (
                                  <div
                                    ...
                                    style={{
                                      ...
                                      backgroundColor:
                                        msg.role === 'AI' ? 'var(--primary-color, #6366f1)' : '#e5e7eb',
                                      color: msg.role === 'AI' ? 'white' : '#1f2937',
                                      marginLeft: msg.role === 'AI' ? '30%' : '0',
                                    }}
                                  >
                              ...
                              <div style={styles.conclusion}>
                                <div style={styles.conclusionGrid}>
                                  <div style={styles.conclusionField}>
                                    <span style={styles.fieldLabel}>Quality Score</span>
                                    <span style={styles.fieldValue}>
                                      {call.conclusion.quality_score}/5
                                    </span>
                                  </div>
                                  <div style={styles.conclusionField}>
                                    <span style={styles.fieldLabel}>Sentiment</span>
                                    <span style={styles.fieldValue}>
                                      {call.conclusion.customer_sentiment}
                                    </span>
                                  </div>
                                  <div style={styles.conclusionField}>
                                    <span style={styles.fieldLabel}>Appointment</span>
                                    <span style={styles.fieldValue}>
                                      {call.conclusion.appointment_booked ? (
