 ...
 *
 * Historical note: email/SMS steps may contain attachmentRefsJson from older
 * flyer workflows. The flyer picker UI has been removed, but existing refs are
 * still round-tripped on save so persisted sequence data is not wiped.
 */
